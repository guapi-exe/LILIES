...
function reload_header(name){
    load_info(`https://api.gametools.network/bf1/stats/?format_values=true&name=${name}&lang=zh-cn`).then(data=>{
...
function reload_weapons(name){
    load_info(`http://127.0.0.1:8099/api/bf1weapons?name=${name}`).then(data=>{
        console.log(data)
        let weapons_html = ``
...
function reload_vehicles(name){
    load_info(`http://127.0.0.1:8099/api/bf1vehicles?name=${name}`).then(data=>{
        console.log(data)
        let vehicles_html = ``
        for(let weapon in data){
...
function reload_classes(name){
    load_info(`http://127.0.0.1:8099/api/bf1classes?name=${name}`).then(data=>{
        console.log(data)
        let classes_html = ``
        for(let weapon in data){
